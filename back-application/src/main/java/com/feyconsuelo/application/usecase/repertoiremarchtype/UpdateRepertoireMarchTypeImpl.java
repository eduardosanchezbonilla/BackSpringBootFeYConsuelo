...
public class UpdateRepertoireMarchTypeImpl implements UpdateRepertoireMarchType {
    ...
    @Override
    public void execute(final Long repertoireMarchTypeId, final RepertoireMarchTypeRequest repertoireMarchTypeRequest) {
        ...
        this.repertoireMarchTypeService.update(repertoireMarchTypeId, repertoireMarchTypeRequest);
    }
