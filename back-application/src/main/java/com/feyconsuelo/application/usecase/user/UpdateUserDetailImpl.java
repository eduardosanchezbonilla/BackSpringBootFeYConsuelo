    ...
    public void execute(final UpdateUserDetailRequest updateUserDetailRequest) {
        ...
        if (musician.isPresent()) {
            final MusicianRequest musicianRequest = MusicianRequest.builder()
                    ...
                    .unregistrationDate(musician.get().getUnregistrationDate())
                    .unregistred(musician.get().getUnregistred() == null ? Boolean.FALSE : musician.get().getUnregistred())
                    .dateLastNotificationNonAssistsStreakRehearsals(musician.get().getDateLastNotificationNonAssistsStreakRehearsals())
