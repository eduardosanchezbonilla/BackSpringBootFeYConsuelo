...
public class UpdatePerformanceCrossheadImpl {

    private final PerformanceService performanceService;

    public void update(final Long eventId, final EventCrosshead eventCrosshead) {
        ...
        this.performanceService.updateCrosshead(eventId, eventCrosshead);
    }
