...
public class GetCategoryRepertoireMarchsGroupByTypeImpl implements GetCategoryRepertoireMarchsGroupByType {
    ...
    public List<RepertoireMarchGroupByTypeResponse> execute(final RepertoireMarchGroupByTypeRequest repertoireMarchGroupByTypeRequest) {
        ...
        final List<RepertoireMarchResponse> repertoireMarchs = this.repertoireMarchService.getAllByCategoryId(repertoireMarchGroupByTypeRequest.getCategoryId());
