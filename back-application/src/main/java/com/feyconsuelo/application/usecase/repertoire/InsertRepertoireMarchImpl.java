...
public class InsertRepertoireMarchImpl implements InsertRepertoireMarch {
    ...
    @Override
    public void execute(final RepertoireMarchRequest repertoireMarchRequest) {
        ...
        this.repertoireMarchService.insert(repertoireMarchRequest);
    }
