...
public class RepertoireRehearsalEntityToEventResponseConverter {

    private List<VoiceResponse> getVoiceList(final RepertoireRehearsalEntity rehearsalEntity) {
    ...
    public EventResponse convert(final RepertoireRehearsalEntity rehearsalEntity) {
