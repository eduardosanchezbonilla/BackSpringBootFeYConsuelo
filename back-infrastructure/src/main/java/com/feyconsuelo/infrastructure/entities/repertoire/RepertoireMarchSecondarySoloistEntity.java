...
@Table(schema = "feyconsuelo", name = "repertoire_march_secondary_soloist")
public class RepertoireMarchSecondarySoloistEntity implements Serializable {
    @Serial
    ...
    @LastModifiedDate
    private LocalDateTime modifiedDateMarchSecondarySoloist;

    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "delete_date")
    private LocalDateTime deleteDateMarchSecondarySoloist;

    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "creation_date", nullable = false, updatable = false)
    @CreatedDate
    private LocalDateTime createdDateMarchSecondarySoloist;

    @Column(name = "update_user", nullable = false)
    private String modifiedUserSecondaryMarchMainSoloist;
